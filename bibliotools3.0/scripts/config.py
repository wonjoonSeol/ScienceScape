...
def gen(user, headers):
	...
	if(user != ' '):
		CONFIG={
			...
			"wos_data": os.path.join(users_dir, str(user) + "/data-wos/"),
			"one_file_corpus": os.path.join(users_dir, str(user) + "/Result/one_file_corpus.txt"),
			"reports_directory": os.path.join(users_dir, str(user) + "/Result/report"),

			# step two (parse_and_group.py) mandatory
			"wos_data_grouped": os.path.join(users_dir, str(user) + "/Result/grouped_data"),
			"parsed_data": os.path.join(users_dir, str(user) + "/Result/parsed_data"),
			#output directory
			"output_directory": os.path.join(users_dir, str(user) + "/Result/Output"),
		...
		CONFIG={
			# step one (merging_corpus.py) mandatory
			"wos_data": os.path.join(default_dir, "data-wos/"),
			"one_file_corpus": os.path.join(default_dir, "Result/one_file_corpus.txt"),
			"reports_directory": os.path.join(default_dir, "Result/report"),

			# step two (parse_and_group.py) mandatory
			"wos_data_grouped": os.path.join(default_dir, "Result/grouped_data"),
			"parsed_data": os.path.join(default_dir, "Result/parsed_data"),
			#output directory
			"output_directory": os.path.join(default_dir, "Result/Output"),
